...
export const NAV_ITEMS = [
  ...
  { id: 'references', label: 'References', icon: '📞', section: 'strategic', advanced: true },
  { id: 'contacts', label: 'Contacts', icon: '👤', section: 'strategic', advanced: true },
  { id: 'notes', label: 'Notes', icon: '📓', section: 'strategic' },
  ...
  { id: 'documents', label: 'Documents', icon: '📁', section: 'data', advanced: true },
  { id: 'deck', label: 'Deck Upload', icon: '📎', section: 'data', advanced: true },
  { id: 'integrations', label: 'Integrations', icon: '🔗', section: 'data', advanced: true },
  ...
  { id: 'analytics', label: 'Fund Analytics', icon: '📈', section: 'output', advanced: true },
  { id: 'monitoring', label: 'Monitoring', icon: '🔔', section: 'output', advanced: true },
  { id: 'bulk', label: 'Bulk Actions', icon: '⚡', section: 'output', advanced: true },
  { id: 'comparison', label: 'Compare', icon: '\uD83D\uDCCA', section: 'output', advanced: true },
  { id: 'timeline', label: 'Timeline', icon: '\uD83D\uDCC5', section: 'output', advanced: true },
  { id: 'scoring', label: 'Scoring Models', icon: '\uD83C\uDFAF', section: 'output', advanced: true },
  { id: 'activity', label: 'Activity', icon: '📋', section: 'output', advanced: true },
  { id: 'teamCollab', label: 'Team', icon: '👥', section: 'output', advanced: true },
