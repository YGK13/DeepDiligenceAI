...
export default function OnboardingWizard({ onCreateCompany, onSkip, onComplete, onLoadDemo }) {
  ...
  const renderStep1 = () => (
    ...
    >
      ...
      {/* Show plan options during onboarding so users know the value/cost before committing */}
      <div className="mt-6 pt-5 border-t" style={{ borderColor: THEME.border }}>
        <p className="text-center text-xs font-medium mb-3" style={{ color: THEME.secondary }}>
          Simple pricing — start free, upgrade anytime
        </p>
        <div className="grid grid-cols-3 gap-2 text-center">
          <div className="rounded-lg px-2 py-2.5" style={{ background: THEME.border + '40' }}>
            <p className="text-xs font-bold" style={{ color: THEME.text }}>Free</p>
            <p className="text-lg font-bold" style={{ color: THEME.text }}>$0</p>
            <p className="text-[10px]" style={{ color: THEME.secondary }}>1 company</p>
          </div>
          <div className="rounded-lg px-2 py-2.5 ring-1" style={{ background: THEME.accent + '15', ringColor: THEME.accent }}>
            <p className="text-xs font-bold" style={{ color: THEME.accent }}>Solo</p>
            <p className="text-lg font-bold" style={{ color: THEME.text }}>$49<span className="text-[10px] font-normal" style={{ color: THEME.secondary }}>/mo</span></p>
            <p className="text-[10px]" style={{ color: THEME.secondary }}>10 companies + AI</p>
          </div>
          <div className="rounded-lg px-2 py-2.5" style={{ background: THEME.border + '40' }}>
            <p className="text-xs font-bold" style={{ color: THEME.green }}>Fund</p>
            <p className="text-lg font-bold" style={{ color: THEME.text }}>$199<span className="text-[10px] font-normal" style={{ color: THEME.secondary }}>/mo</span></p>
            <p className="text-[10px]" style={{ color: THEME.secondary }}>Unlimited + decks</p>
          </div>
        </div>
        <p className="text-center mt-2">
          <a href="/pricing" className="text-[11px] hover:underline" style={{ color: THEME.accent }}>
