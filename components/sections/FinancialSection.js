...
// ============================================================
export default function FinancialSection({ data, onChange, company, settings, onAiResult, onAutoFill, confidenceData = {}, lastResearched }) {
  ...
  return (
    <div>
      ...
      <Card title="Financials" subtitle="Fundraising history, burn rate, runway, and financial projections" sectionId="financial" lastResearched={lastResearched}>
        {/* --------------------------------------------------------
